    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 relative">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 25px 25px, #d4af37 2px, transparent 2px)",
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          >
            Choose from flexible timing options designed to fit your schedule.
            All classes are conducted online with personalized attention.
          </motion.p>
        </motion.div>
              ...
              <CardContent>
                ...
                >
                  <p className="text-sm text-slate-800 text-center font-medium">
                    <strong>📍 Important:</strong> All classes are conducted
                    online via Zoom. Meeting link will be shared 30 minutes
                    before each session.
                  </p>
                </motion.div>
              </CardContent>
                ...
                <CardContent>
                  ...
                  >
                    <p className="text-xs text-slate-700 font-medium">
                      💡 <strong>Tip:</strong> Use any online time zone
                      converter to calculate your local time from IST (Indian
                      Standard Time)
                    </p>
                  </motion.div>
                </CardContent>
                    ...
                    {[
                      {
                        ...
                        description:
                          "Complete structured practice with warm-up, asanas, pranayama & meditation",
                      },
                      {
                        icon: "👥",
                        title: "Small Groups",
                      ...
                      },
                      {
                        ...
                        description:
                          "Personal corrections, modifications & progress tracking",
                      },
                      {
                        icon: "📱",
                        title: "WhatsApp Support",
                        description:
                          "24/7 guidance, motivation & doubt clearing",
                      },
                    ].map((feature, index) => (
                      <motion.div
                        key={index}
              ...
              <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 shadow-xl hover:shadow-2xl transition-all duration-500">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-slate-700 mb-4">
                    Contact me for personalized batch recommendations
                  </p>
                  <a
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-4 bg-white rounded-lg shadow-md">
                ...
                <p className="text-sm text-slate-700">
                  20% off for morning batches (6 AM - 9:30 AM)
                </p>
              </div>
              <div className="p-4 bg-white rounded-lg shadow-md">
                ...
                <p className="text-sm text-slate-700">
                  Save 25% when you book 20 sessions in advance
                </p>
              </div>
            </div>
          </motion.div>
